        ...
        <header className="bg-red-600">
            <div className="container mx-auto flex justify-between">
                ...
                <div className="inline-flex py-3 px-3 my-6">
                    <SocialIcon url="https://twitter.com/japhemutai" 
                        className="mr-4" 
                        target="_blank" 
                        fgColor="#fff"
                        style={{
                    ...
                    />
                    <SocialIcon url="https://www.linkedin.com/in/japheth-mutai/" 
                        className="mr-4" 
                        target="_blank" 
                        fgColor="#fff"
                        style={{
                    ...
                    />
                    <SocialIcon url="https://www.youtube.com/channel/UCw4MUc-B9DoFkGSUwJ6VScw" 
                        className="mr-4" 
                        target="_blank" 
                        fgColor="#fff"
                        style={{
